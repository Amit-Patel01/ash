...
/**
 * Premium Vibrant Colorful Light HTML Email Template Builder for Ashnexa Systems
 */
export function createEmailTemplate({
  title = 'Ashnexa Systems',
...
<body>
  <div class="wrapper">
    <div class="main-card">
      ...
      <!-- Clean Light Footer -->
      <div class="footer">
        <p style="margin: 0 0 6px 0; font-size: 13px;"><strong>Ashnexa Systems Pvt Ltd</strong></p>
        <p style="margin: 0 0 10px 0;">India's Premium Tech Learning &amp; Certification Course Platform</p>
        <div style="margin-bottom: 12px;">
          <span class="msme-badge">🛡️ Govt. Registered MSME Hub</span>
        </div>
        <p style="margin: 0;">&copy; ${currentYear} Ashnexa Systems. All rights reserved. | <a href="https://www.ashnexasystems.com">Ashnexa Systems.com</a></p>
      </div>
