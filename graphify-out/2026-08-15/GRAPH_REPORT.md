# Graph Report - amitsolutionhub  (2026-08-15)

## Corpus Check
- 744 files · ~1,730,393 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4378 nodes · 10247 edges · 331 communities (260 shown, 71 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1095 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65209560`
...
- `R()` --indirect_call--> `be()`  [INFERRED]
  legacy_backup/frontend/.chrome-test-5/Default/Extensions/ghbmnnjooekpmoecnnnilnnbdlolhkhi/1.104.1_0/service_worker_bin_prod.js → legacy_backup/frontend/.chrome-test-5/Default/Extensions/ghbmnnjooekpmoecnnnilnnbdlolhkhi/1.104.1_0/offscreendocument_main.js
...
Cohesion: 0.18
Nodes (9): MentorAssignments, MentorBroadcast, MentorCourses, MentorDoubts, MentorLayout, MentorOverview, MentorPage(), MentorProfile (+1 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (56): aa(), af(), ah(), be(), bh(), ce(), Cf(), Cj() (+48 more)
...
Cohesion: 0.08
Nodes (16): mg(), cg(), gg(), mf(), rg(), sg(), td(), tg() (+8 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (56): ag(), ai(), Ak(), b(), Bk(), c(), Ci(), ck() (+48 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (50): AdminLayout(), iconMap, navGroups, ProtectedAdmin(), ProtectedEmployee(), ProtectedStudent(), RoleRedirect(), ChatPanel() (+42 more)
...
Cohesion: 0.06
Nodes (65): ADMIN_EMAIL, approveRequest(), broadcastEmail(), buildBroadcastContent(), createUser(), dedupeEmails(), deleteUser(), deleteUserByEmail() (+57 more)
...
Cohesion: 0.09
Nodes (34): AdminLayout(), iconMap, navGroups, ProtectedEmployee(), ChatPanel(), EMOJIS, formatMsgDateTime(), formatTime() (+26 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (72): { admin }, approveAccountRequest(), assertMySqlReady(), bcrypt, buildFirestoreAccountRequestPayload(), buildFirestoreUserPayload(), buildResetEmailMarkup(), buildResetUrl() (+64 more)
...
Cohesion: 0.04
Nodes (35): ad(), af(), ba(), cc(), cd(), cf(), Ea(), fa() (+27 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (29): AdminAccountRequests(), AdminCourseEnrollments(), AdminDashboard(), AdminInternshipCategories(), COLOR_OPTIONS, EMPTY_FORM, ICON_MAP, ICON_OPTIONS (+21 more)

### Community 16 - "normalize"
Cohesion: 0.07
Nodes (27): ADMIN_PERMISSIONS, AdminPermissions(), getPermissionsArray(), ROLE_PRESETS, AdminReceipts(), getAbsoluteUrl(), numberToWords(), DEFAULT_STATUS (+19 more)
...
Cohesion: 0.08
Nodes (55): AdminTasks(), avatarColors, buildAssigneeRows(), columns, emptyAssignee, getAvatarInitials(), priorityColors, resolveAssigneeFromTask() (+47 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (47): Ae(), Be(), Bf(), ce(), ch(), de(), df(), dh() (+39 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (70): ADMIN_EMAIL, buildVerifyResponseData(), buildVerifyUrl(), createQrCertificate(), generateCertificateId(), generateUniqueCertificateId(), {
...
Cohesion: 0.09
Nodes (49): AdminCourseCategories(), AdminCourses(), compactPlanKey(), CourseEnrollModal(), getPlanIdentity(), loadRazorpayScript(), matchesPlanEnrollment(), normalizePlanKey() (+41 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (45): ac(), ad(), al(), bb(), Bc(), bl(), cd(), dc() (+37 more)
...
### Community 28 - "G"
Cohesion: 0.04
Nodes (60): passport, { createLogger, format, transports }, fs, logger, logsDir, path, ADMIN_EMAILS, enrichDecodedUser() (+52 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (39): b(), bc(), c(), d(), da(), dc(), dg(), e() (+31 more)
...
Cohesion: 0.06
Nodes (32): AdminMessages(), ADMIN_PERMISSIONS, AdminPermissions(), getPermissionsArray(), ROLE_PRESETS, AdminReceipts(), getAbsoluteUrl(), numberToWords() (+24 more)

### Community 32 - "Community 32"
Cohesion: 0.33
Nodes (6): AdminProjects(), parseList(), FEATURE_COLORS, PARTICLES, ProjectDetails(), TECH_COLORS

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (18): $a(), ab(), Ae(), bb(), cb(), db(), de(), eb() (+10 more)
...
Cohesion: 0.11
Nodes (32): bg(), bl(), Cg(), cl(), dd(), eg(), el(), fb() (+24 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (23): { addPaymentJob }, crypto, { logger }, {
  savePayment,
  createEnrollment,
  getEnrollmentsByCourse,
  getSession,
  updateSession,
}, { sendEmail, emailTemplate }, sendEnrollmentEmail(), toggleLive(), verifyPayment() (+15 more)
...
Cohesion: 0.07
Nodes (57): razorpay, razorpay, {
  createCoupon,
  deleteCoupon,
  listCoupons,
  updateCoupon,
  validateCouponForPurchase,
}, createCouponRecord(), deleteCouponRecord(), listAllCoupons(), { logger }, updateCouponRecord() (+49 more)
...
Cohesion: 0.08
Nodes (26): ag(), cg(), cl(), dd(), Dl(), el(), ha(), Ie() (+18 more)
...
Cohesion: 0.04
Nodes (60): AdminAccountRequests(), AdminCourseEnrollments(), AdminDashboard(), AdminEmployees(), avatarColors, departments, employeeRoles, AdminInternshipCategories() (+52 more)
...
Cohesion: 0.09
Nodes (19): ff(), gd(), ke(), L(), le(), lh(), M(), O() (+11 more)

### Community 50 - "Community 50"
Cohesion: 0.18
Nodes (21): Aa(), ai(), bg(), bi(), ci(), di(), fi(), gi() (+13 more)

### Community 51 - "authController.js"
Cohesion: 0.38
Nodes (6): EmployeeLayout(), getFilteredNavItems(), hasPermissionForPath(), iconMap, navItems, PERMISSION_MAP

### Community 52 - "hg"
Cohesion: 0.06
Nodes (63): { adminOnly }, { chatWithAI, getRecommendations, getAIStatus, generateText }, { dispatchDepartmentTask }, dispatchRateLimiter, express, { getDepartmentConfig, updateDepartmentConfig, getExecutionLogs, getPendingProposals, generateRealtimeProposalsFromCodebase, resolveProposal, clearAllProposals }, { logger }, router (+55 more)
...
### Community 54 - ".m"
Cohesion: 0.07
Nodes (24): w(), Ef(), Ff(), Gf(), Hf(), ii(), md(), nd() (+16 more)

### Community 55 - "razorpayController.js"
Cohesion: 0.06
Nodes (37): AppContent(), ProtectedAdmin(), ProtectedMentor(), ProtectedStudent(), RoleRedirect(), AshxOsAnnouncementBar(), DarkModeBackgroundFix(), Footer() (+29 more)
...
### Community 59 - ".X"
Cohesion: 0.22
Nodes (17): bd(), cc(), ec(), hb(), hc(), Ib(), ic(), jc() (+9 more)
...
Cohesion: 0.10
Nodes (36): AdminCoupons(), buildPlanKey(), createBlankForm(), formatDate(), formatDiscount(), toDateInputValue(), AdminEmployees(), avatarColors (+28 more)
...
### Community 65 - "th"
Cohesion: 0.15
Nodes (17): { connectDB, closeDB }, fixTypoInPlans(), cleanup(), { connectDB, closeDB }, EXPORTS_DIR, fs, path, UNUSED_COLLECTIONS (+9 more)

### Community 66 - ".aa"
Cohesion: 0.09
Nodes (19): ah(), be(), bf(), ce(), Ga(), hb(), ih(), ji() (+11 more)
...
Cohesion: 0.09
Nodes (15): bh(), cf(), cm(), Ei(), em(), If(), n(), ph() (+7 more)
...
Cohesion: 0.12
Nodes (13): AshxOsHeroSection(), CATEGORIES, FAQS, Hero(), HERO_PARTICLES, STATS, STEPS, TECH_STACK (+5 more)
...
Cohesion: 0.23
Nodes (15): fc(), hc(), jb(), jc(), Kb(), kc(), lc(), mc() (+7 more)
...
Cohesion: 0.73
Nodes (5): DELETE(), GET(), getQueryId(), PATCH(), verifyAdmin()
...
Cohesion: 0.67
Nodes (5): DELETE(), GET(), getQueryId(), PATCH(), verifyAuth()

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (71): AdminQrCertificates(), buildVerifyUrl(), CERTIFICATE_TYPES, createInitialForm(), formatDisplayDate(), getTypeMeta(), mapCertificateToForm(), resolveAssetSrc() (+63 more)

### Community 100 - "Community 100"
Cohesion: 0.38
Nodes (6): EmployeeTasks(), getPriority(), getStatus(), priorityConfig, statusConfig, TaskCard()

### Community 101 - "route.js"
Cohesion: 0.80
Nodes (4): DELETE(), GET(), getQueryId(), verifyAdmin()
...
### Community 107 - "route.js"
Cohesion: 0.83
Nodes (3): DELETE(), getQueryId(), verifyAuth()
...
### Community 151 - ".Z"
Cohesion: 0.07
Nodes (27): AdminAccountRequests, AdminAIDepartments, AdminAshxWaitlist, AdminCoupons, AdminCourseCategories, AdminCourseEnrollments, AdminCourses, AdminDashboard (+19 more)
...
### Community 309 - "route.js"
Cohesion: 0.53
Nodes (5): DEFAULT_CONFIG, GET(), getConfigFromDb(), POST(), saveConfigToDb()
...
### Community 342 - "EmployeeTasks.jsx"
Cohesion: 0.38
Nodes (6): EmployeeTasks(), getPriority(), getStatus(), priorityConfig, statusConfig, TaskCard()

## Knowledge Gaps
- **1011 isolated node(s):** `@kilocode/plugin`, `Layout`, `About`, `AdminLayout`, `AdminDashboard` (+1006 more)
...
- **Why does `p()` connect `.m` to `Community 7`, `Community 9`, `Community 14`, `Community 18`, `Community 29`?**
  _High betweenness centrality (0.303) - this node is a cross-community bridge._
- **Why does `sendReceiptEmail()` connect `Community 9` to `.m`, `Community 22`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `w()` connect `.m` to `Community 7`, `Community 40`, `Community 42`, `Community 79`, `Community 18`, `razorpayController.js`, `Community 29`, `razorpayController.js`?**
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.03270911360799001 - nodes in this community are weakly interconnected._