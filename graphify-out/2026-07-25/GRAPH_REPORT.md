...
## Corpus Check
- 445 files · ~654,337 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3021 nodes · 7575 edges · 168 communities (149 shown, 19 thin omitted)
...
Nodes (85): mergeUsers(), bcrypt, {
  ...
  createHttpError,
}, forgotPassword(), { getDb }, handleControllerError(), jwt, { logger } (+77 more)
...
Cohesion: 0.06
Nodes (32): w(), AnnouncementPopup(), DarkModeBackgroundFix(), Footer(), GlowBackground(), CATEGORIES, Counter(), FAQS (+24 more)
...
Cohesion: 0.04
Nodes (53): verifyProjectPayment(), { addPaymentJob }, crypto, { logger }, {
  savePayment,
  createEnrollment,
  getEnrollmentsByCourse,
  getSession,
  updateSession,
}, { sendEmail, emailTemplate }, toggleLive(), verifyPayment() (+45 more)
...
Cohesion: 0.05
Nodes (46): AdminAccountRequests(), AdminCourseEnrollments(), AdminDashboard(), AdminLayout(), iconMap, navGroups, AdminProjects(), AdminSales() (+38 more)
...
## Knowledge Gaps
- **603 isolated node(s):** `@kilocode/plugin`, `fs`, `path`, `{ sendEmail, emailTemplate }`, `{ getActiveEnrolledEmails }` (+598 more)
...
- **Why does `p()` connect `Community 34` to `.l`, `Community 8`, `Community 9`, `Community 14`, `Community 18`, `Community 27`?**
