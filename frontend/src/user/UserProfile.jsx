    ...
    <div className="space-y-6 font-['Outfit',sans-serif] pb-20">
      ...
      <div className="relative rounded-[32px] border border-slate-200/90 bg-white p-6 sm:p-8 shadow-sm overflow-hidden">
        ...
        <div className="relative h-36 sm:h-44 rounded-t-[28px] bg-gradient-to-r from-blue-100/70 via-purple-100/50 to-indigo-100/60 -mx-6 -mt-6 sm:-mx-8 sm:-mt-8 mb-4 overflow-hidden group/cover">
          ...
          {/* Top Right Colored Numeric Badges */}
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-5">
            ...
            <div className="pt-2">
              ...
              <p className="mt-1 text-xs sm:text-sm font-medium text-slate-500">
                {profileForm.bio ? profileForm.bio.slice(0, 60) + '...' : 'Learning and growing with SolutionHub'}
          ...
          {/* Right Column: Big Counters (Followers 2,985, Following 132, Likes 548 Style) */}
          <div className="flex items-center gap-8 sm:gap-12 pt-2 border-t lg:border-t-0 border-slate-100">
            <div>
              ...
              <p className="mt-1 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">4</p>
            </div>
            <div>
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Certificates</p>
              <p className="mt-1 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">2</p>
            </div>
            <div>
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Points</p>
              <p className="mt-1 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">548</p>
            </div>
          </div>
