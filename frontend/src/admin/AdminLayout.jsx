...
const navItems = [
  ...
  { path: '/admin/team', label: 'Team', icon: 'group' },
...
export default function AdminLayout({ onLogout }) {
  ...
  const handleSearch = (e) => {
    ...
    else if (q.includes('team')) navigate('/admin/team')
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-gray-900/50 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/"
              className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
