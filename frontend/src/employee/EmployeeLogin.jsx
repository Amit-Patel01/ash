    ...
    <section className="relative w-full min-h-screen pt-24 md:pt-32 pb-20 px-4 transition-colors duration-500">
      <div className="relative z-20 max-w-md mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-slate-800 dark:text-white tracking-tight">AmitSolutionHub Login <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Portal</span></h1>
