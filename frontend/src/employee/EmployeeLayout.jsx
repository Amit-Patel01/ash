  ...
  return (
    <div className="relative h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full opacity-10" style={{ background: 'radial-gradient(circle, #10b981 0%, transparent 70%)', filter: 'blur(60px)' }} />
        <div className="absolute top-1/2 -right-48 h-[500px] w-[500px] rounded-full opacity-5" style={{ background: 'radial-gradient(circle, #06b6d4 0%, transparent 70%)', filter: 'blur(80px)' }} />
        <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full opacity-5" style={{ background: 'radial-gradient(circle, #8b5cf6 0%, transparent 70%)', filter: 'blur(60px)' }} />
      </div>
        ...
        >
            ...
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              {sidebarOpen && (
                <div className="min-w-0">
                  ...
                  <h1 className="truncate text-[15px] font-black text-slate-900 leading-tight">
          ...
          {sidebarOpen && (
            <div className="mx-3 mt-4 rounded-2xl p-3.5" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <div className="flex items-center gap-3">
                <div
                  className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl text-sm font-black text-slate-900 overflow-hidden"
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[13px] font-bold text-slate-900">{employeeName}</p>
            ...
            {filteredNavItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg transition-all duration-200 ${isActive ? '' : 'group-hover:bg-slate-100'}`}
                    style={isActive ? { background: `linear-gradient(135deg, ${item.color.replace('from-', '').replace(' to-', ', ')})`, boxShadow: '0 2px 10px rgba(0,0,0,0.3)' } : {}}
                  >
                    <span className={isActive ? 'text-slate-900' : 'text-slate-500 group-hover:text-slate-300'}>
                      {iconMap[item.icon]}
                    </span>
                  </span>
          ...
          <div className="p-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <button
              ...
              title="Logout"
              className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-slate-400 transition-all duration-200 hover:text-slate-900 ${sidebarOpen ? '' : 'justify-center'}`}
          ...
          <button
            ...
            className="absolute -right-3.5 top-20 hidden h-7 w-7 items-center justify-center rounded-full text-slate-300 transition-all duration-200 hover:text-slate-900 lg:flex"
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="rounded-xl p-2 text-slate-400 transition hover:text-slate-900 lg:hidden"
                ...
                <div>
                  ...
                  <h2 className="text-xl font-black text-slate-900 tracking-tight">Welcome back, {employeeName.split(' ')[0]}</h2>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <Link
                  to="/employee/profile"
                  className="flex items-center gap-2 rounded-xl px-2.5 py-1.5 text-xs font-semibold text-slate-400 transition-all hover:text-slate-900 shadow-sm"
                  style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                >
                  <div className="w-6 h-6 rounded-lg overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center text-[10px] font-black text-slate-900 shrink-0">
                    {employeeAvatar ? (
                      <img src={employeeAvatar} alt={employeeName} className="w-full h-full object-cover" />
                    ) : (
                      employeeInitial
                ...
                <Link
                  to="/"
                  className="flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-[12px] font-semibold text-slate-400 transition-all hover:text-slate-900"
                  style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                >
