    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        <div>
          ...
          <p className="mt-3 text-4xl font-black text-slate-900 tracking-tight">{value}</p>
...
export default function EmployeeHomeDashboard() {
  ...
  const renderHRWidget = () => (
    <div className="space-y-6">
      <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
        <h3 className="text-base font-black text-slate-900 mb-1">Recruitment Funnel</h3>
              ...
              <div className="mt-3 flex gap-2">
                {c.status !== 'Interview Scheduled' && (
                  <button
                    ...
                    className="rounded-lg bg-slate-100 hover:bg-slate-200 px-3 py-1.5 text-[11px] font-bold text-slate-900 transition border border-slate-300"
                  >
                    Schedule Interview
                  </button>
                )}
      ...
      <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
        <h3 className="text-base font-black text-slate-900 mb-1">Attendance Sync Terminal</h3>
        ...
        <div className="flex items-center justify-between gap-4">
          <button
            ...
            className="rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:opacity-90 px-4 py-2.5 text-xs font-black text-slate-900 transition shadow-lg shadow-emerald-950/40 disabled:opacity-50"
          >
  ...
  const renderSupportWidget = () => (
    <div className="rounded-3xl p-6 space-y-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <div>
        <h3 className="text-base font-black text-slate-900 mb-1">WhatsApp & Mail Queries</h3>
          ...
          <div key={t.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-start justify-between gap-3 mb-2">
              <div>
                ...
                <h4 className="text-[13px] font-bold text-slate-900 mt-0.5">{t.student}</h4>
              </div>
              <span className={`rounded-full px-2 py-0.5 text-[9px] font-black uppercase tracking-wider ${
            ...
            {activeTicketId === t.id ? (
              <div className="space-y-3">
                <textarea
                  ...
                  className="w-full h-20 rounded-xl bg-slate-950 border border-slate-300 px-3 py-2 text-xs text-slate-900 placeholder:text-slate-600 outline-none focus:border-cyan-400"
                />
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-slate-100 hover:bg-slate-200 px-3 py-1.5 text-[11px] font-bold text-slate-400 border border-slate-300 transition"
                  >
                    Cancel
                  </button>
                </div>
  ...
  const renderBDEWidget = () => (
    <div className="space-y-6">
      <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
        <h3 className="text-base font-black text-slate-900 mb-1">Partnership Lead Board</h3>
        ...
        <div className="space-y-3">
          {leads.map(l => (
            <div key={l.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h4 className="text-[13px] font-bold text-slate-900">{l.college}</h4>
      ...
      <div className="rounded-3xl p-6 animate-pulse" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
        <h3 className="text-base font-black text-slate-900 mb-3">Log New Partnership Lead</h3>
        <form onSubmit={handleAddLead} className="space-y-3">
          <input
            ...
            required
            className="w-full rounded-xl bg-slate-950 border border-slate-300 px-3 py-2 text-xs text-slate-900 placeholder:text-slate-600 outline-none focus:border-cyan-400"
          />
          <input
            type="text"
          ...
          <button
            type="submit"
            className="rounded-xl bg-slate-100 hover:bg-slate-200 px-4 py-2 text-xs font-bold text-slate-900 border border-slate-300 transition"
          >
            Create Lead File
          </button>
        </form>
  ...
  const renderMarketingWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Campaign Analytics & Boost</h3>
        ...
        {campaigns.map(c => (
          <div key={c.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-center justify-between mb-2">
              <div>
                <h4 className="text-[13px] font-bold text-slate-900">{c.name}</h4>
  ...
  const renderWriterWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Editorial Content Queue</h3>
      ...
      <div className="space-y-3">
        {drafts.map(d => (
          <div key={d.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="text-[13px] font-bold text-slate-900">{d.title}</h4>
  ...
  const renderLMSWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">LMS Upload Pipeline</h3>
          ...
          return (
            <div key={c.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <div className="flex items-start justify-between mb-2">
                <div>
                  <h4 className="text-[13px] font-bold text-slate-900">{c.title}</h4>
  ...
  const renderTrainingWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Live Meeting Session Scheduler</h3>
      ...
      <div className="space-y-3">
        {sessions.map(s => (
          <div key={s.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div>
              <h4 className="text-[13px] font-bold text-slate-900">{s.topic}</h4>
  ...
  const renderProjectWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Weekly Project Submissions</h3>
      ...
      <div className="space-y-3">
        {reports.map(r => (
          <div key={r.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="text-[13px] font-bold text-slate-900">{r.intern}</h4>
  ...
  const renderDesignerWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Creative Production Requests</h3>
      ...
      <div className="space-y-3">
        {designTasks.map(t => (
          <div key={t.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="text-[13px] font-bold text-slate-900">{t.item}</h4>
  ...
  const renderDeveloperWidget = () => (
    <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <h3 className="text-base font-black text-slate-900 mb-1">Tech Hotfix Deploy Console</h3>
      ...
      {isDeploying ? (
        ...
        <div className="space-y-4">
          <div className="rounded-2xl p-4 bg-slate-950 border border-slate-200 space-y-2">
          ...
          {bugList.length > 0 && (
            <button
              ...
              className="rounded-xl bg-gradient-to-r from-cyan-500 to-sky-500 hover:opacity-90 px-4 py-2.5 text-xs font-black text-slate-900 transition shadow-lg shadow-cyan-950/40 w-full"
            >
  ...
  const renderOperationsWidget = () => (
    <div className="rounded-3xl p-6 space-y-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <div>
        <h3 className="text-base font-black text-slate-900 mb-1">Daily Operations Task-sheet</h3>
      ...
      <div className="space-y-2.5">
        {checklists.map(c => (
          <div
            ...
            className="flex items-center gap-3 rounded-2xl p-4 transition-all cursor-pointer hover:bg-slate-100"
  ...
  const renderPlacementWidget = () => (
    <div className="rounded-3xl p-6 space-y-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-base font-black text-slate-900 mb-1">Placement Job Openings</h3>
        ...
        {jobOpenings.map(j => (
          <div key={j.id} className="rounded-2xl p-4 transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-start justify-between">
              <div>
                <h4 className="text-[13px] font-bold text-slate-900">{j.company}</h4>
          ...
          <div className="space-y-6">
            <div className="rounded-3xl p-6" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
              <div className="flex items-start justify-between gap-3 mb-6">
                <div>
                  <h2 className="text-base font-black text-slate-900">Task Pipeline</h2>
                  <p className="mt-0.5 text-[12px] text-slate-500">Status breakdown of your workload</p>
                </div>
                <Link
                  to="/employee/tasks"
                  className="flex-shrink-0 rounded-xl px-3 py-1.5 text-[11px] font-bold text-slate-300 transition-all hover:text-slate-900"
              ...
              {myProjects.length === 0 ? (
                ...
                <div key={project.id} className="rounded-2xl p-4 mb-2" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                  <div className="flex items-center justify-between gap-3 mb-2">
                    <p className="text-[13px] font-semibold text-slate-900 truncate">{project.name}</p>
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="max-w-2xl">
            <div className="flex items-center gap-4 mb-4">
              <div
                className="flex h-14 w-14 items-center justify-center rounded-2xl text-xl font-black text-slate-900"
              ...
              <div>
                ...
                <h1 className="text-2xl font-black tracking-tight text-slate-900 lg:text-3xl">{displayName}</h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 lg:min-w-[280px]">
            {[
              ...
              <div key={tile.label} className="rounded-2xl p-4" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className={`mt-2 font-black text-slate-900 ${tile.small ? 'text-xs mt-3 text-emerald-400' : 'text-2xl'}`}>{tile.value}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          >
            ...
            <div className="relative flex items-start justify-between">
              <div>
                ...
                <p className="mt-3 text-4xl font-black text-slate-900 tracking-tight">{stat.value}</p>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[2fr_1fr]">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl p-5" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 4px 32px rgba(0,0,0,0.3)' }}>
            <h2 className="text-[13px] font-black text-slate-900 mb-0.5">Quick Actions</h2>
              ...
              {currentQuickActions.map(link => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-[12px] font-semibold text-slate-900">{link.label}</p>
          ...
          {['lms coordinator', 'training coordinator', 'project coordinator', 'student support executive', 'placement & career support executive'].includes(normalizedRoleKey) && (
            <div className="rounded-3xl p-5" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
              <h2 className="text-[13px] font-black text-slate-900 mb-0.5">Student Registration Feed</h2>
                ...
                {recentActivity.length === 0 ? (
                  ...
                  <div key={activity.id} className="rounded-2xl p-3.5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <p className="text-[12px] font-semibold text-slate-900 truncate">{activity.userName || activity.studentName || 'Student'}</p>
