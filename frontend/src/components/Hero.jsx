  ...
  return (
    <>
      ...
      <div className="ash-canvas w-full min-h-screen relative overflow-hidden text-slate-800">
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-200/60 dark:border-slate-800/60">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900 via-violet-900 to-slate-950 p-8 sm:p-12 md:p-16 text-center text-white shadow-2xl shadow-indigo-500/20 border border-white/15">
            {/* Ambient Background Lights & Grids */}
            <div className="absolute -top-24 -left-24 w-96 h-96 bg-indigo-500/30 rounded-full blur-3xl pointer-events-none animate-pulse" />
            <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-fuchsia-500/30 rounded-full blur-3xl pointer-events-none animate-pulse" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(#fff_1px,transparent_1px)] [background-size:24px_24px] opacity-10 pointer-events-none" />

            {/* Floating Glass Badges for Large Screens */}
            <div className="hidden lg:flex absolute left-8 top-12 items-center gap-3 px-4 py-2.5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl pointer-events-none animate-bounce-slow">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] font-medium text-indigo-200">500+ Alumni Reviews</p>
              </div>
            </div>

            <div className="hidden lg:flex absolute right-8 bottom-12 items-center gap-3 px-4 py-2.5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl pointer-events-none animate-bounce-slow" style={{ animationDelay: '1s' }}>
              ...
              <div className="text-left">
                <p className="text-xs font-bold text-white">Certified Learning</p>
                <p className="text-[10px] font-medium text-indigo-200">Industry Verified</p>
              </div>
            </div>

            <div className="relative z-10 max-w-3xl mx-auto space-y-6">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold bg-white/10 backdrop-blur-md border border-white/20 text-indigo-100 shadow-inner">
                <Sparkles className="w-4 h-4 text-amber-300 animate-pulse" />
                <span>Limited Seats • Cohort Starting Soon</span>
              </div>

              {/* Title */}
              <h2 className="ash-display text-3xl sm:text-5xl font-black tracking-tight leading-tight">
                Start Your{' '}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-pink-200 to-cyan-300">
                  Learning Journey Today
                </span>
              </h2>

              {/* Subtext */}
              <p className="text-sm sm:text-base text-indigo-100/90 leading-relaxed font-medium max-w-xl mx-auto">
                Take the next step toward building practical skills through structured internship programs, live mentorship, and hands-on projects.
              </p>

              {/* Feature Chips */}
              <div className="pt-2 flex flex-wrap items-center justify-center gap-3 text-xs font-semibold text-indigo-100">
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/10 border border-white/10 backdrop-blur-sm">
                  <Check className="w-3.5 h-3.5 text-emerald-400" /> Real-world Projects
                </span>
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/10 border border-white/10 backdrop-blur-sm">
                  <Check className="w-3.5 h-3.5 text-emerald-400" /> Recognized Certification
                </span>
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/10 border border-white/10 backdrop-blur-sm">
                  <Check className="w-3.5 h-3.5 text-emerald-400" /> 1-on-1 Mentorship
                </span>
              </div>
              ...
              <div className="pt-6 flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  to="/signup"
                  className="group relative inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl font-bold text-sm bg-gradient-to-r from-white via-slate-100 to-white text-indigo-950 shadow-2xl shadow-indigo-500/50 hover:shadow-white/30 hover:scale-[1.02] active:scale-95 transition-all duration-300"
                >
                  <span>Apply Now</span>
                  <ArrowRight className="w-4 h-4 text-indigo-600 transition-transform duration-300 group-hover:translate-x-1" />
                </Link>

                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold text-sm bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-md active:scale-95 transition-all duration-300"
                >
