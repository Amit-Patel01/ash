      ...
      <div className="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-3 group mb-6">
            ...
            <span className="text-2xl font-black text-white tracking-tighter uppercase italic">
              Solution<span className="text-blue-500">Hub</span>
            </span>
          </Link>
          <h1 className="text-3xl font-extrabold text-white tracking-tight mb-2">Welcome Back</h1>
          <p className="text-slate-400 text-sm font-medium">Continue your journey with the best agency solutions.</p>
        </div>
        ...
        <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 sm:p-10 shadow-2xl shadow-black/50">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link to="/forgot-password?from=customer" size="sm" className="text-xs font-bold text-blue-500 hover:text-blue-400 transition-colors">Forgot password?</Link>
              </div>
              <div className="relative group">
                <input 
            ...
            <div className="flex items-center px-1">
              <label className="flex items-center gap-3 cursor-pointer group select-none">
                <input type="checkbox" className="w-5 h-5 rounded-lg border-white/10 bg-white/5 text-blue-600 focus:ring-blue-500/50 transition-all checked:bg-blue-600" />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl text-sm font-bold text-slate-300 hover:text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
          >
            {googleLoading ? (
        ...
        <p className="text-center mt-8 text-[11px] text-slate-600 font-bold uppercase tracking-[0.2em] leading-relaxed">
          Secure Infrastructure Provided by <span className="text-blue-500/80">SolutionHub Security</span>
          <br />© {new Date().getFullYear()} SolHub. All Rights Reserved.
        </p>
      </div>
    </div>
  )
