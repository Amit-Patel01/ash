    ...
    return (
      <section className="pd-canvas min-h-screen pt-10 lg:pt-14 pb-20 flex items-center justify-center text-slate-900">
        ...
        <div className="text-center px-4 relative z-10">
          ...
          <Link to="/projects" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-full font-bold hover:shadow-xl hover:-translate-y-0.5 shadow-lg shadow-indigo-500/25 transition-all duration-300">
    ...
    <section className="pd-canvas relative min-h-screen pt-10 lg:pt-14 pb-20 overflow-hidden text-slate-900">
      ...
      <div className={`w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="text-center">
          <Link to="/projects" className="inline-flex items-center gap-2 font-medium transition-colors text-slate-600 hover:text-indigo-600">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
