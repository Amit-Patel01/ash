                ...
                {finalTeamMembers.map((member, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex flex-col items-center text-center w-full">
                      ...
                      <h4 className="text-xl font-bold text-slate-800 mb-1">{member.displayName}</h4>
                      <p className="text-blue-600 font-semibold text-sm mb-4">{member.jobTitle || member.role}</p>

                      <div className="flex flex-wrap justify-center gap-1.5 mb-6">
                        {(Array.isArray(member.skills) ? member.skills : []).slice(0, 3).map(skill => (
                          <span key={skill} className="px-2.5 py-1 bg-white/60 rounded-lg text-[13px] font-bold text-slate-500 border border-white/50">{skill}</span>
                        ))}
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 px-6 py-2.5 bg-slate-900 text-white rounded-2xl text-xs font-bold hover:bg-black active:scale-95 transition-all shadow-md group/link"
                      >
