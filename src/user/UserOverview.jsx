    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-16">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/courses" className="text-xs font-black text-blue-600 hover:text-blue-700 dark:text-blue-400 flex items-center gap-1">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/user/my-courses" className="text-xs font-black text-blue-600 hover:text-blue-700 dark:text-blue-400 flex items-center gap-1">
              ...
              return (
                <div key={c.id || idx} className="p-5 rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs space-y-3">
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-500 font-medium pt-1">
                    ...
                    <Link href="/user/my-courses" className="font-bold text-slate-900 dark:text-white hover:text-blue-600">
                      Resume →
                    </Link>
                  </div>
                </div>
