        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
              ...
              <div className="flex justify-center md:justify-start gap-3">
                {[
                  ...
                  <a
                    ...
                    className={`w-10 h-10 rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-sm border ${social.bg} ${social.color}`}
            ...
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                {[
                  ...
                  <li key={link.name}>
                    <Link href={link.to} className="hover:text-blue-500 dark:hover:text-indigo-400 hover:translate-x-1.5 transition-all inline-flex items-center gap-2.5 group">
            ...
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                {[
                  { to: '/legal/privacy-policy', name: 'Privacy Policy' },
                  { to: '/legal/terms', name: 'Terms of Service' },
                  { to: '/legal/refund-policy', name: 'Refund Policy' },
                  { to: '/legal/grievance', name: 'Grievance' },
                ].map((link) => (
                  <li key={link.name}>
                    <Link href={link.to} className="hover:text-blue-500 dark:hover:text-indigo-400 hover:translate-x-1.5 transition-all inline-flex items-center gap-2.5 group">
            ...
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              <div className="space-y-5 text-sm font-medium text-slate-500 dark:text-slate-400 w-full">
                ...
                <a href="tel:+917874248481" className="flex items-center justify-center md:justify-start gap-4 group hover:text-emerald-600 dark:hover:text-emerald-400 transition-all">
                  <span className="w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all border bg-emerald-50 border-emerald-200 text-emerald-600 dark:bg-emerald-950/50 dark:border-emerald-800 dark:text-emerald-400 shadow-sm">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2} aria-hidden="true">
                      <rect x="7.5" y="3.5" width="9" height="17" rx="2.2" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M11 17.5h2" />
                    </svg>
                  </span>
                  <span className="group-hover:translate-x-1.5 transition-transform text-slate-700 dark:text-slate-300 font-semibold">+91 7874248481</span>
                </a>

                <div className="flex items-center justify-center md:justify-start gap-4 group">
                  <span className="w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all border bg-rose-50 border-rose-200 text-rose-600 dark:bg-rose-950/50 dark:border-rose-800 dark:text-rose-400 shadow-sm">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2} aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s7-5.7 7-11a7 7 0 1 0-14 0c0 5.3 7 11 7 11Z" />
                      <circle cx="12" cy="10" r="2.5" />
                    </svg>
                  </span>
                  <span className="text-slate-700 dark:text-slate-300 font-semibold">Godhra, Gujarat, India</span>
                </div>
              </div>
            </div>
          </div>
