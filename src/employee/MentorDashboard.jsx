...
import {
  ...
  getEmployeeDisplayName } from './employeeUtils'
            ...
            <div className="space-y-3">
              {myCourses.length === 0 ? (
                <div className={`rounded-2xl p-12 text-center ${isDark ? 'bg-white/4' : 'bg-slate-50'}`}>
                  ...
                  <Link href="/employee/course-manage" className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white text-sm font-bold shadow-md hover:-translate-y-0.5 transition-all">
                    View Course Manager →
                  </Link>
                </div>
              ) : (
