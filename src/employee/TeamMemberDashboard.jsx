...
import {
  ...
  getEmployeeKeyList,
  courseBelongsToEmployee } from './employeeUtils'
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[1.1fr_1.1fr_0.9fr]">
        <div className="rounded-[28px] border border-slate-300 bg-white/70 p-6 shadow-2xl shadow-black/20">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link href="/employee/tasks" className="rounded-full border border-slate-300 bg-slate-100 px-3 py-1.5 text-xs font-bold text-slate-200 transition hover:bg-slate-200 hover:text-slate-900">Open board</Link>
          </div>
        ...
        <div className="rounded-[28px] border border-slate-300 bg-white/70 p-6 shadow-2xl shadow-black/20">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link href="/employee/course-manage" className="rounded-full border border-slate-300 bg-slate-100 px-3 py-1.5 text-xs font-bold text-slate-200 transition hover:bg-slate-200 hover:text-slate-900">Manage now</Link>
          </div>
          <div className="mt-6 space-y-3">
          ...
          <div className="rounded-[28px] border border-slate-300 bg-white/70 p-6 shadow-2xl shadow-black/20">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                <Link key={link.to} href={link.to} className="block rounded-2xl border border-white/8 bg-white/[0.03] p-4 transition hover:border-cyan-400/20 hover:bg-white/[0.06]">
