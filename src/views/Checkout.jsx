        ...
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white/40 backdrop-blur-2xl rounded-3xl p-10 border border-white/60 shadow-xl">
            ...
            <div className="space-y-3">
              <Link href="/login" className="block w-full px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-bold hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-200 transition-all text-center">
                Sign In
              </Link>
              <Link href="/signup" className="block w-full px-6 py-3.5 bg-white/60 border border-slate-200 text-slate-700 rounded-2xl font-bold hover:bg-white transition-all text-center">
                Create Account
              </Link>
            </div>
            <Link href={`/projects/${slug}`} className="text-xs text-slate-400 hover:text-slate-600 transition-colors flex items-center justify-center gap-1 mt-4">
    ...
    return (
      <section className="min-h-screen pt-28 pb-20 bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/projects" className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full font-bold">
            Browse Projects
          </Link>
        </div>
      </section>
    ...
    <section className="relative min-h-screen pt-28 pb-20 overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className={`w-full max-w-2xl mx-auto px-4 sm:px-6 relative z-10 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="flex items-center gap-2 text-sm text-slate-500 mb-8">
          ...
          <span>/</span>
          <Link href={`/projects/${slug}`} className="hover:text-blue-600 transition-colors">{project.title}</Link>
          <span>/</span>
        ...
        <div className="text-center mt-8">
          <Link href={`/projects/${slug}`} className="inline-flex items-center gap-2 text-slate-600 hover:text-blue-600 font-medium transition-colors">
