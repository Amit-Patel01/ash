              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                  {relatedCourses.map(item => (
                    <Link key={item.id} href={`/courses/${item.slug || item.id}`} className={`rounded-2xl border p-5 transition-all hover:-translate-y-1 hover:shadow-lg ${isDark ? 'border-slate-800 bg-slate-900/50' : 'border-slate-200 bg-white'}`}>
