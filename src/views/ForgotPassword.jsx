...
export default function ForgotPassword() {
  ...
  if (verifyingCode) {
    return (
      <div className="min-h-screen w-full relative flex items-center justify-center p-4 bg-slate-50 overflow-hidden">
        <div className="relative z-10 text-center">
          <div className="w-16 h-16 border-4 border-indigo-500/30 border-t-indigo-500 rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-slate-500 font-medium">Verifying security link...</p>
        </div>
      </div>
    )
  }
  ...
  if (success) {
    return (
      <div className="min-h-screen w-full relative flex items-center justify-center p-4 bg-slate-50 overflow-hidden">
        <div className="absolute top-0 -left-4 w-96 h-96 bg-blue-500/10 rounded-full blur-[120px] animate-pulse pointer-events-none"></div>
        <div className="absolute bottom-0 -right-4 w-96 h-96 bg-indigo-500/10 rounded-full blur-[120px] animate-pulse pointer-events-none delay-700"></div>
        
        <div className="relative z-10 w-full max-w-[440px] animate-in zoom-in duration-700">
          <div className="bg-white border border-slate-200 rounded-[32px] p-10 shadow-[0_24px_60px_-12px_rgba(15,23,42,0.08)] text-center">
            ...
            <h2 className="text-3xl font-extrabold text-slate-800 mb-3">Password Updated</h2>
            <p className="text-slate-500 mb-8 leading-relaxed">Your password has been reset successfully. Redirecting you to login...</p>
    ...
    return (
      <div className="min-h-screen w-full relative flex items-center justify-center p-4 bg-slate-50 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out text-center">
          <div className="bg-white border border-slate-200 rounded-[32px] p-8 sm:p-10 shadow-[0_24px_60px_-12px_rgba(15,23,42,0.08)]">
            ...
            <h2 className="text-3xl font-extrabold text-slate-800 mb-3">Check Your Email</h2>
            <p className="text-slate-500 mb-8 leading-relaxed">We've sent a password reset link to <span className="text-blue-600 font-bold">{email}</span>. Please check your inbox to continue.</p>
            
            <div className="bg-blue-500/5 rounded-2xl p-6 mb-8 border border-blue-500/10">
              <p className="text-sm text-blue-600 font-medium">Didn't receive the email? Check your spam folder or try again in a few minutes.</p>
            </div>

            <Link href={getBackPath()} className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-indigo-600 transition-all group">
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center p-4 bg-slate-50 overflow-hidden selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <div className="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-3 group mb-6">
            ...
            <span className="text-2xl font-black text-slate-800 tracking-tighter uppercase italic">
              Solution<span className="text-blue-600">Hub</span> <span className="text-xs not-italic font-medium text-slate-400 ml-1 opacity-50">SECURITY</span>
            </span>
          </Link>
        ...
        <div className="bg-white border border-slate-200 rounded-[32px] p-8 sm:p-10 shadow-[0_24px_60px_-12px_rgba(15,23,42,0.08)]">
          <form onSubmit={resetToken ? handleConfirmReset : handleRequestReset} className="space-y-6">
            {error && (
              <div className="flex items-center gap-3 p-4 bg-red-500/10 border border-red-200 rounded-2xl text-red-700 animate-in shake duration-500">
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    required 
                    className="w-full px-5 py-4 bg-slate-50/50 border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition-all duration-300 text-sm font-medium"
                  />
          ...
          <div className="mt-8 pt-8 border-t border-slate-100">
            <Link href={getBackPath()} className="flex items-center justify-center gap-2 text-sm font-bold text-slate-500 hover:text-indigo-600 transition-all group">
              <svg className="w-4 h-4 group-hover:-translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
              </svg>
              <span>Back to login</span>
        ...
        <p className="text-center mt-8 text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] leading-relaxed">
