...
import {
  ...
  getTeamMemberKeys } from '../utils/teamProfiles'
          ...
          <div className="profile-hero">
            <div className="profile-container">
              <div className="profile-card" style={{ textAlign: 'center', maxWidth: 600, margin: '0 auto' }}>
                ...
                <Link href="/about#team-section" className="profile-link-btn">
    ...
    <>
      ...
      <div className="profile-page">
        ...
        <section className="profile-hero">
          <div className="profile-container">
            <Link href="/about#team-section" className="profile-link-btn secondary profile-animate" style={{ marginBottom: 24 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 32, alignItems: 'start', padding: '0 32px 32px 32px', marginTop: '-50px', position: 'relative', zIndex: 2 }}>
                ...
                <div style={{ paddingTop: '58px' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 24 }}>
                    ...
                    <Link href="/contact" className="profile-link-btn secondary">
