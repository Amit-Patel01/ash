...
const mapFirestoreUser = (doc, { includeSensitive = false } = {}) => {
  ...
  const user = {
    ...
    lastLoginDevice: doc.lastLoginDevice || "",
    lastLoginAt: doc.lastLoginAt ? toIsoString(doc.lastLoginAt) : null,
    currentSessionId: doc.currentSessionId || null,
...
module.exports = {
  ...
  revokeUserSession: async (identifier) => {
    return updateManagedUser(identifier, { currentSessionId: null });
  },
};
