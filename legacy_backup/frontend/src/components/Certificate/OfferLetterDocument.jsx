...
export default function OfferLetterDocument({ certificate, template, className = '' }) {
  ...
  const bodyParas = certificate?.certificateText
    ...
    : [
        `We are delighted to welcome you for the internship in <strong>${domain}</strong> at our organization. This internship is observed by <strong>Ashnexa Systems</strong> as a learning opportunity for you, spanning a duration of <strong>${duration}</strong>.`,
