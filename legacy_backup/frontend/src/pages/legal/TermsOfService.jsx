...
const TermsOfService = () => {
  ...
  return (
    <>
      <SEO title="Terms of Service | Ashnexa Systems" description="Terms and conditions for utilizing Ashnexa Systems's internship and trading mentorship programs." />
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
          ...
          <div className="space-y-8 text-slate-600 leading-relaxed max-w-none">
            <section>
              ...
              <p>By registering for an internship, purchasing a mentorship program, or utilizing the Ashnexa Systems platform, you agree to comply with and be bound by these Terms of Service. If you do not agree, please refrain from using our services.</p>
            </section>
