...
const RefundPolicy = () => {
  ...
  return (
    <>
      <SEO title="Refund Policy | Ashnexa Systems" description="Cancellation and refund policies for our premium mentorship and internship programs." />
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
          ...
          <div className="space-y-8 text-slate-600 leading-relaxed max-w-none">
            <section>
              ...
              <p>At Ashnexa Systems, we strive to deliver extreme value in all our mentorship programs and internship cohorts. Because digital access to proprietary knowledge, curriculum blueprints, and live sessions cannot be easily "returned", we maintain a strict policy regarding refunds and cancellations.</p>
            </section>
